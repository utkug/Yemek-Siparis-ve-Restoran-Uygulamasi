...
{
    public partial class Foods1 : Form
    {
        ...
        NpgsqlConnection baglanti = new NpgsqlConnection("Server=localhost;Port=5432;Database=DBYemek;User Id=postgres;Password=1234");
        NpgsqlCommand komut;
